...
(defmethod parse ((m machine))
  (consume m)
  (cond ((delta m "empty" 'host-ident-p) (move m "host"))
        ((delta m "host" 'host-ident-p) (move m "host"))
        ((delta m "separator" 'host-ident-p) (move m "host"))
        ((delta-final m #\. "host") (move m "separator"))
        ((delta-final m #\: "host") (move m "final*"))
        ((delta-final m #\/ "host") (move m "final*"))
        ((final m "host") (move m "final"))
        (t (move m "error")))
