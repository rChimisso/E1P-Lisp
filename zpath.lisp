...
(defmethod save-and-check ((m machine))
  (save m)
  (cond ((or (string= (state m) "id44") (string= (state m) "separator"))
...
(defmethod parse ((m machine))
  (consume m)
  (cond ((delta m "slash" 'alpha-p) (move m "id44"))
        ((delta m "id44" 'alnum-p) (move m "id44"))
        ((delta m "separator" 'alnum-p) (move m "id44"))
        ((delta m "open-id8" 'alpha-p) (move m "id8"))
        ((delta m "id8" 'alnum-p) (move m "id8"))
        ((delta-final m #\/ "empty") (move m "slash"))
        ((delta-final m #\. "id44") (move m "separator"))
        ((delta-final m #\( "id44") (move m "open-id8"))
        ((delta-final m #\) "id8") (move m "path"))
        ((delta-final m #\? "id44" "path") (move m "final*"))
        ((delta-final m #\# "id44" "path") (move m "final*"))
        ((final m "empty" "id44" "path") (move m "final"))
        (t (move m "error")))
