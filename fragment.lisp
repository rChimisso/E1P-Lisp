...
(defmethod parse ((m machine))
  (consume m)
  (cond ((delta m "sharp" 'allowed-p) (move m "fragment"))
        ((delta m "fragment" 'allowed-p) (move m "fragment"))
        ((delta-final m #\# "empty") (move m "sharp"))
        ((final m "empty" "fragment") (move m "final"))
        (t (move m "error")))
